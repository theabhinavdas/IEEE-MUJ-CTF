   ...
   if (isset($_POST['flag'])) {
      ...
      if ($flag_text == "nmap") {
         try {
            ...
            $stmt = $conn->prepare("UPDATE ctf_users SET `level7` = 100 where email = :email");
            $stmt->execute(array('email' => $email));
            $_SESSION['is_auth_for_8'] = true;
            header("location: 888.php");
  ...
  <body>
    ...
    <div class="jumbotron">
      ...
      <div class="container">
        ...
        <p>What network-mapping tool was demonstrated in today's workshop?</p>
