...
if (isset($_POST['flag-submit'])) {
   ...
   if (isset($_POST['flag'])) {
      ...
      if ($flag_text == "wireshark" || $flag_text == "Wireshark") {
         try {
            $conn = new PDO('mysql:host=theabhinavdas.ipagemysql.com;dbname=ctf_db', $dbuser, $dbpass);
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $stmt = $conn->prepare("UPDATE ctf_users SET `level9` = 100 where email = :email");
            $stmt->execute(array('email' => $email));
            $_SESSION['is_auth_for_8'] = true;
            header("location: 1010.php");
  ...
  <body>
    ...
    <div class="jumbotron">
      ...
      <div class="container">
        ...
        <p>Name the world's most famous packet-sniffer!</p>
		  <p>
			Hint 1: Google can help you. The answer starts with 'w' ;) It was in the list of tools I showed you on the slides!</br>
			Hint 2: The answer is one-word ;)
		  </p>
      </div>
    </div>
