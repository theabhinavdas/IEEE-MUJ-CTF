...
if (isset($_POST['flag-submit'])) {
   ...
   if (isset($_POST['flag'])) {
      ...
      if ($flag_text == "maska_patties_so_yum") {
         try {
            $conn = new PDO('mysql:host=theabhinavdas.ipagemysql.com;dbname=ctf_db', $dbuser, $dbpass);
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $stmt = $conn->prepare("UPDATE ctf_users SET `level2` = 100 where email = :email");
            $stmt->execute(array('email' => $email));
            $_SESSION['is_auth_for_3'] = true;
            header("location: 33333.php");
  ...
  <body>
    ...
    <div class="jumbotron">
      ...
      <div class="container">
        ...
        <p>Mr. John Doe learned security the hard way. He started researching all about cryptography and data protection against intruders/attackers. He realised that he could store the encrypted flag like in Level 1, in the HTML source of this page. Can you crack the code to get the original flag back?</p>
        <p>
           Hint: What type of encoding is it? Is it Base64? ;) (<a href="https://www.base64decode.org/">https://www.base64decode.org/</a>)
        </p>
      </div>
    </div>
