...
if (isset($_POST['flag-submit'])) {
   ...
   if (isset($_POST['flag'])) {
      ...
      if ($flag_text == "LOLCODE") {
         try {
            $conn = new PDO('mysql:host=theabhinavdas.ipagemysql.com;dbname=ctf_db', $dbuser, $dbpass);
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $stmt = $conn->prepare("UPDATE ctf_users SET `level5` = 100 where email = :email");
            $stmt->execute(array('email' => $email));
            $_SESSION['is_auth_for_6'] = true;
  ...
  <body>
    ...
    <div class="jumbotron">
      ...
      <div class="container">
        ...
        <p>Mr. John Doe has to find the esoteric language which uses AWSUM THX and O NOES as error handling.</p>
        <p>
