...
if (isset($_POST['flag-submit'])) {
   ...
   if (isset($_POST['flag'])) {
      ...
      if ($flag_text == "ProFTPD 1.2.10") {
         try {
            $conn = new PDO('mysql:host=theabhinavdas.ipagemysql.com;dbname=ctf_db', $dbuser, $dbpass);
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $stmt = $conn->prepare("UPDATE ctf_users SET `level3` = 100 where email = :email");
            $stmt->execute(array('email' => $email));
            $_SESSION['is_auth_for_4'] = true;
            header("location: 4444.php");
  ...
  <body>
    ...
    <div class="jumbotron">
      ...
      <div class="container">
        ...
        <p>Mr. John Doe has received an email stating that he would be paid $1000 to discover the software and version of the software running on port 21 at the IP address: 66.96.147.105!</p>
        <p>
           Hint 1: <a href="">Nmap is a great tool!?</a> (For those that don't have nmap installed, you should download it, or just use an online port-scanning website like this - <a href="https://hackertarget.com/nmap-online-port-scanner/">https://hackertarget.com/nmap-online-port-scanner/</a>).
			  Hint 2: If the output looks like this:</br>
		     </br>
			  21/tcp&nbsp;&nbsp;&nbsp;   open&nbsp;&nbsp;&nbsp;     ftp&nbsp;&nbsp;&nbsp;           ZFT 1.2.10</br>
		  	  </br>
			  Then the answer/flag would be:  <b>ZFT 1.2.10</b>
        </p>
      </div>
    </div>
    ...
    <!-- FLAG = bWFza2FfcGF0dGllc19zb195dW0= ---->
