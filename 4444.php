   ...
   if (isset($_POST['flag'])) {
      ...
      if ($flag_text == "104723") {
         try {
            ...
            $stmt = $conn->prepare("UPDATE ctf_users SET `level4` = 100 where email = :email");
            $stmt->execute(array('email' => $email));
            $_SESSION['is_auth_for_5'] = true;
            header("location: 555555.php");
  ...
  <body>
    ...
    <div class="jumbotron">
      ...
      <div class="container">
        ...
        <p>By listing the first six prime numbers: 2, 3, 5, 7, 11, and 13, we can see that the 6th prime is 13. Help John write a program to find the 9999th prime number.</p>
        <p>
           Hint 1: <a href="">https://en.wikipedia.org/wiki/Sieve_of_Eratosthenes</a></br>
			  Hint 2: Sometimes, writing code is difficult. This answer can also be Googled ;) But if you show me the code when I ask you, 100 points extra!
        </p>
      </div>
    </div>
