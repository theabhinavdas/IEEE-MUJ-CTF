...
if (isset($_POST['flag-submit'])) {
   ...
   if (isset($_POST['flag'])) {
      ...
      if ($flag_text == "onion_rings_are_epic") {
         try {
             $conn = new PDO('mysql:host=theabhinavdas.ipagemysql.com;dbname=ctf_db', $dbuser, $dbpass);
             $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);

             $stmt = $conn->prepare("UPDATE ctf_users SET `level1` = 100 where email = :email");
             $stmt->execute(array('email' => $email));
             $_SESSION['is_auth_for_2'] = true;
  ...
  <body>
    ...
    <div class="jumbotron">
      ...
      <div class="container">
        ...
        <p>Mr. John Doe is very new to the field of Web-application development. He made this page. He said he couldn't remember the flag, so he stored it somewhere in the HTML of this page. Do you think you can find it?</p>
      </div>
    </div>
